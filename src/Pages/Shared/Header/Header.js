                ...
                <Toolbar>
                    ...
                    {isMobile ? (
                        ...
                        <div className={classes.navlinks}>
                            ...
                            {
                                user.email ? <div><Link to="/" onClick={logOut} className={classes.link}>LogOut {user.displayName}</Link></div> : <Link to='/login' className={classes.link}>Login</Link>
                            }
                            {
                                user.email ? "" : <Link to="/register" className={classes.link}>
                                    Register
                                </Link>
                            }
